...
const FoodHallOrderingSystem = () => {
  ...
  const venues = [ 
    { id: 1, name: "Downtown Food Hall", image: "/Images/foodhall1.jpeg", address: "123 Main St" },
     { id: 2, name: "Waterfront Market", image: "/Images/FoodHall2.jpg", address: "456 Harbor Blvd" },
     { id: 3, name: "Urban Eats Collective", image: "/Images/FoodHall4.jpg", address: "789 City Center" },
     { id: 4, name: "Urban Eats Collective", image: "/Images/FoodHall5.jpeg", address: "789 City Center" },
     { id: 5, name: "Urban Eats Collective", image: "/Images/FoodHall6.jpeg", address: "789 City Center" },
     { id: 6, name: "Urban Eats Collective", image: "/Images/FoodHall7.jpeg", address: "789 City Center" },

     
  ];

  const restaurants = [
        { id: 1, venueId: 1, name: "Gourmet Burger Co.", cuisine: "American", description: "Juicy, handcrafted burgers with fresh ingredients.", image: "/Images/venue.jpg" },
        { id: 2, venueId: 2, name: "Sushi Delight", cuisine: "Japanese", description: "Fresh and authentic sushi rolls made by top chefs.", image: "/Images/venue3.jpeg" },
        { id: 3, venueId: 3, name: "Pasta Heaven", cuisine: "Italian", description: "Homemade pasta with delicious sauces.", image: "/Images/urbaneats.avif" },
        { id: 4, venueId: 4, name: "Vegan Bites", cuisine: "Plant-based", description: "Delicious and healthy plant-based meals.", image: "/Images/restaurant.jpg" },
        { id: 5, venueId: 5, name: "Taco Fiesta", cuisine: "Mexican", description: "Authentic Mexican street tacos and more.", image: "/Images/restar1.jpg" },
        { id: 6, venueId: 6, name: "Churro Station", cuisine: "Mexican", description: "Sweet churros and Mexican desserts.", image: "/Images/restar2.jpeg" }
